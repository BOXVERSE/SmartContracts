...
contract DeployFactoryScript is Script {
    ...
    address constant EXPECTED_FACTORY = 0x24F3118A61E2e728fA6b29C69dEC67dA0DA29840;
    address constant EXPECTED_IMPLEMENTATION = 0x1723d60814f203FdF3fCc4dD5Bc8C183e56Ef1D4;
    ...
    function run() public {
        ...
        address implementation = SafeSingletonDeployer.broadcastDeploy({
            ...
            salt: 0x2438ae5ce1ff7750c1e09c4b28e2a04525da412f91561eb5b57729977f591fbb
        });
        ...
        address factory = SafeSingletonDeployer.broadcastDeploy({
            ...
            salt: 0x178d06dab87f67bb2d83470a70c8975a2c99872f290058fb43bcc47da5f0390c
        });
